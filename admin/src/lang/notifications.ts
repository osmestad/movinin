...
const strings = new LocalizedStrings({
  ...
  no: {
    ...
    DELETE_NOTIFICATION: 'Er du sikker på at du vil slette denne varslingen?',
    DELETE_NOTIFICATIONS: 'Er du sikker på at du vil slette disse varslingsmeddelelsene?',
  },
})
