...
# Usage: ./__scripts/build-and-push-mi-backend.sh <github-username> <github-token>
# Example: ./__scripts/build-and-push-mi-backend.sh osmestad ghp_YourTokenHere

GITHUB_USER="$1"
GITHUB_TOKEN="$2"
IMAGE_NAME="ghcr.io/$GITHUB_USER/mi-backend:latest"
