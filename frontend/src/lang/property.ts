...
const strings = new LocalizedStrings({
  ...
  no: {
    ...
    MINIMUM_AGE_NOT_VALID: `Minimumsalderen må være større enn eller lik ${env.MINIMUM_AGE} år.`,
    ADDRESS: 'Adresse',
    ...
    SIZE: 'Størrelse',
    AIRCON: 'Klimakontroll',
    FURNISHED: 'Møblert',
    PETS_ALLOWED: 'Kjæledyr tillatt',
    SOLD_OUT: 'Utsolgt',
    HIDDEN: 'Skjult',
    IMAGES: 'Bilder',
    DESCRIPTION_REQUIRED: 'Beskrivelse er obligatorisk',
